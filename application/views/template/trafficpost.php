                ...
                <div class="col-md-12 container-fluid box box-shadow">
                    <div class="row container-fluid row-adjust top-details">
                        <div class="col-md-3 row-adjust">
                            <h5><?php echo $post->account_username;?></h5><br>
                            <h6><?php echo $post->location;?></h6>
                        </div>
                        <div class="col-md-3 row-adjust">
                            <div class="pictures"><img style="width: 200px; height: 150px;"  src="<?php echo $address."/ESCMOBILE/".$post->image_path ?>" /></div>
                        ...
                        <div class="col-md-3 row-adjust">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo site_url('dashboard/updatepost/'.$post->image_id);?>">Approve Post</a></li>
                                    <li><a href="<?php echo site_url('dashboard/updatepost/'.$post->image_id);?>">Decline Post</a></li>
                                </ul>
                            </div>
                        </div>
